...
import { apiUpdatePassword } from '../../apis/axios';
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                ...
                <div>
                    <div class="relative z-0">
                        <input type="text" {...register('email')} id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                    ...
                    {errors.email && <p id="standard_error_help" class="mt-2 text-xs text-red-600 ">{errors?.email?.message}</p>}
                </div>

                <div>
                    <div class="relative z-0">
                        <input type="text" {...register('password')} id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                    ...
                    {errors.password && <p id="standard_error_help" class="mt-2 text-xs text-red-600 ">{errors?.password?.message}</p>}
                </div>
                ...
                <div>
                    ...
                    {errors.newPassword && <p id="standard_error_help" class="mt-2 text-xs text-red-600 ">{errors?.newPassword?.message}</p>}
