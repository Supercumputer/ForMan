...
import { apiDeleteCart, apiUpadteQuantiTy } from '../../apis/axios';
...
function CartItem({ item, isBtnDelete = true, isBtnQuantity = true, sizeBtnQuantity = '' }) {
    ...
    return (
        <li class="flex pb-3 mb-3 border-b border-gray-200">
            ...
            <div class="ml-4 flex flex-1 flex-col">
                <div>
                    ...
                    <p class="my-1 text-sm text-gray-500">{`${item.variant_id?.size.sizeName} / ${item.variant_id?.color.colorName}`}</p>
                </div>
