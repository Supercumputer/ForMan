...
import { getDefaultAddress } from '../../apis/addressApi';
    ...
    return (
        <div className="flex-1">
            ...
            <div className="flex flex-col gap-3">
                ...
                <textarea id="message"{...register("note")} rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-0 focus:border-[#1F2937] bg-transparent" placeholder="Ghi chú"></textarea>
            </div>
        </div>
    )
}
