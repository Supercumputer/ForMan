      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 py-5">
        <div className="flex flex-col">
          ...
          <div className="flex space-x-2 items-center mb-3">
            ...
            <div className="w-8 h-8 border rounded flex text-[#666666] ">
              <i className="fa-brands fa-tiktok m-auto"></i>
            </div>
            <div className="w-8 h-8 border rounded flex text-[#666666] ">
        ...
        <div className="flex flex-col">
          ...
          <ul className="flex flex-col space-y-2 text-sm">
            <li className="text-[#666666]">
              <i className="fa-solid fa-angles-right"></i> Tìm kiếm
            </li>
            <li className="text-[#666666]">
              <i className="fa-solid fa-angles-right"></i> Giới thiệu
            </li>
            <li className="text-[#666666]">
              <i className="fa-solid fa-angles-right"></i> Chính sách đổi trả
            </li>
            <li className="text-[#666666]">
            ...
            <li className="text-[#666666]">
              <i className="fa-solid fa-angles-right"></i> Liên hệ
            </li>
          </ul>
        </div>
