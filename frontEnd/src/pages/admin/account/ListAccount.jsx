...
const ListAccount = () => {
  ...
  useEffect(() => {
    callApiGetAllUser(pathName, currentPage, limit, keyword);
  }, [pathName, currentPage, limit, keyword]);
      ...
      <div className="rounded-md p-2 bg-[#fff] dark:bg-slate-800">
        <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-2">
          ...
          >
            {pathName === "managers" && (
              <Dropdown.Item>
                <Link to={`${pathAdmin.accounts}/${pathName}/create`}>
                  Create
                </Link>
              </Dropdown.Item>
            )}
                ...
                >
                  ...
                  <Table.Cell>
                    <div className="flex gap-2">
                      ...
                      <ButtonPro
                        to={`${pathAdmin.accounts}/${pathName}/edit/${item?._id}`}
                      ...
                      <ButtonPro
                        to={`${pathAdmin.accounts}/${pathName}/detail/${item?._id}`}
